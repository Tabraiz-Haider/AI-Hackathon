...
sidebar_path = Path(PROJECT_ROOT) / "sidebars.js"
...
# 4) Update sidebars.js (append my-book entries if file exists)
sidebar_entries = """
    # === auto-added my-book entries ===
    'my-book/introduction',
  """
for i in range(1, 11):
    sidebar_entries += f"  'my-book/chapter-{i}',\n"
sidebar_entries += "  'my-book/conclusion',\n"

if sidebar_path.exists():
    # naive append: add to end of file
    with open(sidebar_path, "a", encoding="utf-8") as f:
        f.write("\n" + sidebar_entries + "\n")
    sidebar_updated = True
else:
    # create a simple sidebars.js
...
print(f"Sidebar file: {sidebar_path}  (updated or created)")
